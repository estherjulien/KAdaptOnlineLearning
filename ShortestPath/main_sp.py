...
num_cores = 8
num_instances = num_cores*7
N = 100
env_list = [Graph(N=N, gamma_perc=0.01, first_stage_ratio=0.3, max_degree=5, throw_away_perc=0.3, inst_num=i+56) for i in np.arange(num_instances)]
