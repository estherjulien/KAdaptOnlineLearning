...
def sub_tree_pass(K, env, att_series, pass_track, state_data_init, weight_data_init, n_back_track, theta_i, theta_init,
                  zeta_init, tot_scens_init, att_index, i_explore, max_depth=5, x_static=None):
    # Initialize
    results = None
