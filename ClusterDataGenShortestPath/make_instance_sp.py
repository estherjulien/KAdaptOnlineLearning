...
if __name__ == "__main__":
    ...
    with open(f"ClusterDataGenShortestPath/Instances/sp_env_N{N}_{inst_num}.pickle", "wb") as handle:
    ...
    with open(f"ClusterDataGenShortestPath/Instances/sp_env_output_N{N}_{inst_num}.pickle", "wb") as handle:
